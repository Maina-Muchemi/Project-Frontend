...
const USER_REGEX = /^[A-z]{2,15}$/
const PWD_REGEX = /^[A-z0-9!@#$%]{5,11}$/
        ...
        <>
            ...
            <form className="form" onSubmit={e => e.preventDefault()}>
                ...
                <label className="form-label" htmlFor="username">
                    Username: <span className="header">[3-15 letters]</span></label>
                <input
                ...
                <label className="form-label" htmlFor="password">
                    Password: <span className="header"></span> <span className="header">[6-14 chars include]</span></label>
                <input
                ...
                <p>NOTE: this will affect the employees access to the platform.</p>
